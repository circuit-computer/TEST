<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_ComplainLogin.aspx.vb" Inherits="Site_frm_ComplainLogin" %>
...
<html lang="en">
<head>
    <title>Welcome to Complain System</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form id="Form1" class="login100-form validate-form p-b-33 p-t-5" runat="server">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter username">
                        <asp:TextBox ID="txt_Login_ID" runat="server" CssClass="input100" placeholder="User name"></asp:TextBox>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        ...
                        <asp:TextBox ID="txtPassword" runat="server" CssClass="input100" placeholder="Password"
...
<%--<%@ Page Language="VB"  MasterPageFile="~/Site/MasterPage.master" AutoEventWireup="false" CodeFile="frm_ComplainLogin.aspx.vb" Inherits="Site_frm_ComplainLogin" %>
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <asp:TextBox ID="txt_Login_ID" runat="server" CssClass="form-control" Enabled="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
