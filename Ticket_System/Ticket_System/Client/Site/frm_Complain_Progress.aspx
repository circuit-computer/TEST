<%@ Page Language="VB" MasterPageFile="~/Site/MasterPage.master" AutoEventWireup="false" CodeFile="frm_Complain_Progress.aspx.vb" Inherits="Site_frm_Complain_Progress" %>
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Complain No</label>

                                    <div class="col-sm-5">
                                        <%--<asp:TextBox ID="txtUserID" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>--%>
                                        <asp:TextBox ID="txt_Ticket_No" runat="server" CssClass="form-control"
